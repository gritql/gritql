...
export declare const typeDirectives: {
...
export declare const postExecutedDirectives: {
    ...
    diff: (context: PostExecutedContext) => {
        ({ replacedPath, originFullObject, value, batches, }: {
            replacedPath: any;
            originFullObject: any;
            value: any;
            batches: any;
    ...
    indexed: (context: PostExecutedContext) => {
        ({ value, originFullObject, batches }: {
            value: any;
            originFullObject: any;
            batches: any;
        }): {
    ...
    filter: (context: PostExecutedContext) => {
        ({ value, globalReplacedPath, originFullObject, row, batches, q, }: {
            value: any;
